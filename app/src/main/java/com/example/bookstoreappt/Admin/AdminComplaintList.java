...
import com.example.bookstoreappt.Adapter.AdminComplaintAdapter;
...
public class AdminComplaintList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(AdminComplaintList.this));
        ...
        reference.child("Complaints").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.getChildrenCount()>0){
                    ...
                    AdminComplaintAdapter adapter = new AdminComplaintAdapter(AdminComplaintList.this, arrayList);
                    recyclerView.setAdapter(adapter);

                }else{
                    dialog.dismiss();
                    Toast.makeText(AdminComplaintList.this, "No Record Found", Toast.LENGTH_SHORT).show();
                }
            }
