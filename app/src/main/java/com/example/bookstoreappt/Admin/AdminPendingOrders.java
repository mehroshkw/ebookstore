...
public class AdminPendingOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(AdminPendingOrders.this));
    }
        ...
        reference.child("Orders").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.getChildrenCount()>0){
                    ...
                    AdminOrderAdapter adapter = new AdminOrderAdapter(AdminPendingOrders.this, arrayList);
                    recyclerView.setAdapter(adapter);

                }else{
                    dialog.dismiss();
                    Toast.makeText(AdminPendingOrders.this, "No Record Found", Toast.LENGTH_SHORT).show();
                }
            }
