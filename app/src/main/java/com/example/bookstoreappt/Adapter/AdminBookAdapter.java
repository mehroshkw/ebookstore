...
public class AdminBookAdapter extends RecyclerView.Adapter<AdminBookAdapter.MyViewHolder> {
    ...
    //constructor
    public AdminBookAdapter(Context context, ArrayList<Book> arrayList) {
...
//                            holder.ratingBar.setEnabled(false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView tvTitle, tvCategory, tvAuthor, tvPrice, tvStatus, tvPublisher, tvRating, tvReview;
        RatingBar ratingBar;
