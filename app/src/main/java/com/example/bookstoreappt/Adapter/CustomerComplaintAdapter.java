...
public class CustomerComplaintAdapter extends RecyclerView.Adapter<CustomerComplaintAdapter.MyViewHolder> {
    ...
    //constructor
    public CustomerComplaintAdapter(Context context, ArrayList<Complaint> arrayList) {
...
//        dialog.show();
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            linearLayout = itemView.findViewById(R.id.linearResponse);
