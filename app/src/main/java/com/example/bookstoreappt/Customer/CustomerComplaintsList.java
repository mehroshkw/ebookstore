...
public class CustomerComplaintsList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_complaints_list);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(CustomerComplaintsList.this));
        ...
        reference.child("Complaints").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.getChildrenCount()>0){
                    ...
                    Toast.makeText(CustomerComplaintsList.this,"" + snapshot.getChildrenCount(), Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                    ...
                    CustomerComplaintAdapter adapter = new CustomerComplaintAdapter(CustomerComplaintsList.this, arrayList);
                    recyclerView.setAdapter(adapter);

                }else{
                    dialog.dismiss();
                    Toast.makeText(CustomerComplaintsList.this, "No Record Found", Toast.LENGTH_SHORT).show();
                }
            }
